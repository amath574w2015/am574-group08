...
We can see a decrease in peak value for this case compared with the same plots for square column case. However, this decrease between two cases from GeoClaw is not as large as that between two cases from experiment. 
\par
