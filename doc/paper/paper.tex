...
\par
The arrival time of the peak predicted by geoclaw is about 0.08 second earlier than the time measured from experiment and in experiment, the jump is more like a a smooth increase. 
If we zoom in \ref{fig:waveheight_nocolumn} for smaller time range from 3s to 4s, we get \ref{fig:waveheight_nocolumn_zoomin}.
