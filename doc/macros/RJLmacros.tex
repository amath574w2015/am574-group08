...
\newcommand\amdqiphj{\amdq_{i+1/2,j}}
\newcommand\apdqiphj{\apdq_{i+1/2,j}}
\newcommand\apmdqimj{\apmdq_{i-1/2,j}}
\newcommand\amdqijm{\amdq_{i,j-1/2}}
\newcommand\apdqijm{\apdq_{i,j-1/2}}
\newcommand\amdqijph{\amdq_{i,j+1/2}}
\newcommand\apdqijph{\apdq_{i,j+1/2}}
\newcommand\apmdqijm{\apmdq_{i,j-1/2}}
\newcommand\bmdqimj{\bmdq_{i-1/2,j}}
\newcommand\bpdqimj{\bpdq_{i-1/2,j}}
\newcommand\bpmdqimj{\bpmdq_{i-1/2,j}}
\newcommand\bmdqijm{\bmdq_{i,j-1/2}}
\newcommand\bpdqijm{\bpdq_{i,j-1/2}}
\newcommand\bpmdqijm{\bpmdq_{i,j-1/2}}
\newcommand\bmdqijph{\bmdq_{i,j+1/2}}
\newcommand\bpdqijph{\bpdq_{i,j+1/2}}
